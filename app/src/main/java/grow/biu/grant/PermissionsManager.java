...
public class PermissionsManager {
    ...
    public static String[] STORAGE_PERMISSION = new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE};
    public static String[] AUDIO_PERMISSION = new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO};
    public static String[] CAMERA_PERMISSION = new String[]{Manifest.permission.CAMERA};
    public static String[] EXTERNAL_SHARE_PERMISSION = new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE};
    public static String[] LOCATION_PERMISSION = new String[]{Manifest.permission.ACCESS_COARSE_LOCATION};

    private final Set<String> mPermissions = new HashSet<String>(1);
    private final List<PermissionsResultAction> mPendingActions = new ArrayList<PermissionsResultAction>();
    ...
    public boolean hasStoragePermission(@NonNull String[] permissions, @NonNull int[] grantResults) {
     ...
     * if disable, checked no toast, return false
     * if disable, not't check no toast, return true.
     *
     * @param activity
     * @param permissions
     * @return
    ...
    public synchronized boolean shouldShowPermissions(Activity activity, String permissions) {
